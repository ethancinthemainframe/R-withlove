...
Description
The data source provides prevalence by age group and, when properly aggregated, provides the overall obesity prevalence by state for US adults in 2024. The data contains Guam, District of Columbia, US Virgin Islands, and Puerto Rico, which are omitted from the map visualization.
